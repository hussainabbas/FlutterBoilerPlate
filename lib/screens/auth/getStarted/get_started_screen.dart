...
import 'package:FlutterBoilerPlater/helpers/resources/image_resources.dart';
import 'package:FlutterBoilerPlater/helpers/resources/routes_resources.dart';
import 'package:FlutterBoilerPlater/screens/auth/getStarted/get_started_bloc.dart';
import 'package:FlutterBoilerPlater/widgets/intro_page.dart';
...
class _GetStartedScreenState extends State<GetStartedScreen> {
  ...
  final List<Widget> _pages = [
    const IntroPage(
      ...
      smallText: 'Choose when, how and who provides your support at home and in community.',
    ),
    const IntroPage(
      imageAsset: ImageResources.slide2,
      bigText: "You're In Control With FlutterBoilerPlater",
    ...
    const IntroPage(
      ...
      smallText: 'Set your budget, check your expenditure and monitor your funding balances all in one easy place.',
    ),
  ];
